...
func registerSolutions(r *runner.SolutionRunner) {
	solutions := map[string]runner.TestFunc{
		...
		"MaximumSubarray":                               RunTestMaximumSubarray,
		...
		"PalindromeNumber":                              RunTestPalindromeNumber,
		...
		"TaskScheduler":                                 RunTestTaskScheduler,
		...
		"ValidParentheses":                              RunTestValidParentheses,
